...
@endif
@section('sub_title' , 'Manage Client Accounts')
@section('content')
...
.page-item.active .page-link{
  ...
  border-color: green;
        ...
        {{ Form::open(['action' => 'AccountController@search', 'method' => 'POST' , 'class' => 'new-form-class']) }}
                        ...
                        <tr>
                         ...
                         <th>Delete</th>
                          <th>Status</th>
                                                        ...
                                                        <tbody> 
                                           @foreach($getall_accounts as $value)
<tr>
    
    <td>{{$value->name}}</td>
   <td class="text-underline"><a href= "{{url('account') . '/' . $value->id . '/view' }}">View </a></td>
<td class="text-underline"><a href= "{{url('account') . '/' . $value->id . '/edit' }}">Edit</a></td>

<td> <a class="delete-account text-underline delete-user" href="{{route('account.destroy', $value->id)}}">Delete</a></td> 

 <td class="text-capitalize">
 <span id="get_status">{{$value->status}}</span></td>
